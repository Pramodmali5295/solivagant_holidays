    ...
    <section id="about" ref={container} className="scroll-mt-20 md:scroll-mt-28 bg-secondary/10 w-full relative overflow-hidden">
      <div className="flex flex-col lg:flex-row items-stretch min-h-[500px] lg:min-h-[550px]">
        ...
        <div className="lg:w-1/2 flex items-center bg-white/50 backdrop-blur-md">
          <div className="w-full px-6 md:px-12 lg:px-20 py-8 md:py-10 max-w-[800px]">
            <div className="flex flex-col justify-center space-y-8 h-full">
              <div className="why-text-reveal space-y-6">
                ...
                <h2 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-foreground leading-[1.1]">
                  Our Experience<br />
                  Meet High Quality<br />
                  Standard
                </h2>
                <p className="font-body text-base md:text-xl text-muted-foreground leading-relaxed border-l-4 border-primary/20 pl-6 py-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 features-grid">
                {features.map((feat) => (
                  <div
                    key={feat.title}
                    className="flex items-start gap-4 p-2 feature-reveal group"
                  >
                    <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-primary text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <feat.icon size={28} />
                    </div>
                    <div>
                      <h3 className="font-body text-lg md:text-xl font-bold text-foreground group-hover:text-primary transition-colors">
                        {feat.title}
                      </h3>
              ...
              <div className="why-text-reveal pt-8">
                <div className="p-8 md:p-10 bg-white rounded-3xl border border-primary/10 shadow-2xl relative overflow-hidden group hover:shadow-primary/5 transition-all duration-500">
                  <div className="absolute top-0 left-0 w-2 h-full bg-primary" />
                  <p className="font-display italic text-foreground text-2xl md:text-3xl font-bold leading-relaxed relative z-10">
                    "Your Journey to exotic destinations starts here!!.."
                  </p>
                  <div className="mt-6 flex items-center gap-4 relative z-10">
                    <div className="w-12 h-[2px] bg-primary/40" />
                    <p className="font-body text-primary font-bold tracking-widest uppercase text-sm md:text-base">Solivagant Team</p>
                  </div>
                </div>
              </div>
            </div>
